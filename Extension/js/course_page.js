...
function addDistributionGraphs(courseDistributions, professorsDistributions) {
	...
	chrome.runtime.sendMessage( {
		...
		if (response != undefined) {
			...
			var semestersDefault = document.createElement("div");
			semestersDefault.id = "semester_default";
			$("#graphs").append(semestersDefault);
			...
			$("#graphs").tabs({
				create: function (event, ui) {
					...
					$("#semester_default").CanvasJSChart(options1);
