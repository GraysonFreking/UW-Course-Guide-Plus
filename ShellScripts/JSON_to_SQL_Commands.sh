...
python ../PythonScripts/Schedule_JSON_to_SQL.py ../grade_dist_JSONs/PDF_Schedule_of_Classes_1152.json ../Database/tempdb.db
python ../PythonScripts/Schedule_JSON_to_SQL.py ../grade_dist_JSONs/PDF_Schedule_of_Classes_1144.json ../Database/tempdb.db
python ../PythonScripts/Schedule_JSON_to_SQL.py ../grade_dist_JSONs/PDF_Schedule_of_Classes_1142.json ../Database/tempdb.db
python ../PythonScripts/Schedule_JSON_to_SQL.py ../grade_dist_JSONs/PDF_Schedule_of_Classes_1134.json ../Database/tempdb.db
#cd ../PythonScripts
